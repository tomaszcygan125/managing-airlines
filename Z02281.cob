      ...
      ******************************************************************
      *                                                                 
      *  PROGRAM IS CALLED WHEN A USER WANTS TO ADD A FLIGHT            
      *                                                                 
      *  IN THIS PROGRAM USER WILL CHOSE IF HE WANTS TO ADD A SINGLE    
      *  OR SCHEDULED FLIGHT                                            
      *                                                                 
      *                                                                 
      *    IN BOTH SCENARIOS THE SAME (Z02292) PROGRAM WILL BE CALLED   
      *   BUT IT WILL BE CALLED WITH DIFFERENT FLAGS                    
      *                                                                 
      *                                                                 
      *                          (0223)                                 
      *                                                                 
      *    IT IS VERY SIMPLE PROGRAM WITH VERY SIMPLE LOGIC             
      *                                                                 
      ******************************************************************
      *                  CHANGE LOG                                     
      *                                                                 
      ...
      ******************************************************************
       2152-EVALUATE-USER-CHOICE.                                       
           ...
           DISPLAY 'CHOI2I ' CHOI2I                                     
           IF CHOI1I = 'X' AND CHOI2I = 'X' THEN                        
              MOVE ' PLEASE CHOOSE ONLY 1 OPTION   '                    
              TO WS-Z02141-I-ERROR-MESSAGE(1)                           
              PERFORM 2300-CALL-ERROR-ROUTINE                           
           END-IF                                                       
           IF CHOI1I = 'X' THEN                                         
              PERFORM  2610-CALL-ADD-A-SINGLE-FLIGHT                    
              DISPLAY 'CALL ADD SINGLE '                                
           END-IF                                                       
           IF CHOI2I = 'X' THEN                                         
              PERFORM  2620-CALL-ADD-A-SCHED-FLIGHT                     
      ...
      ******************************************************************
       2300-CALL-ERROR-ROUTINE.                                         
           ...
           .                                                            
      ******************************************************************
      *                   2610-CALL-ADD-A-SINGLE-FLIGHT                 
      ******************************************************************
       2610-CALL-ADD-A-SINGLE-FLIGHT.                                   
           SET SO-M-FIRST-WITHOUT TO TRUE                               
           SET SO-ADD-A-SINGLE  TO TRUE                                 
           EXEC CICS                                                    
            XCTL PROGRAM(CT-ADD-SINGLE-PROG) COMMAREA(WS-ZZEC0215)      
           END-EXEC                                                     
           PERFORM 2200-CHECK-EIBRESP                                   
           .                                                            
      ******************************************************************
      *                  2620-CALL-ADD-A-SCHED-FLIGHT                   
      ******************************************************************
       2620-CALL-ADD-A-SCHED-FLIGHT.                                    
           SET SO-M-FIRST-WITHOUT TO TRUE                               
      ...
      ******************************************************************
       3000-FINAL.                                                      
           ...
           WHEN SO-FINAL-WITH-COMMAREA                                  
              EXEC CICS                                                 
                  RETURN TRANSID('0223') COMMAREA(WS-ZZEC0215)          
              END-EXEC                                                  
              PERFORM 2200-CHECK-EIBRESP                                
